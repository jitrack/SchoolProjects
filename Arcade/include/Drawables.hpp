...
struct Color
{
    ...
    static Color Grey() { return Color(80, 80, 80, 0xFF); }
    ...
    bool operator==(Color const &color) const noexcept { return red == color.red && green == color.green && blue == color.blue && alpha == color.alpha; }
